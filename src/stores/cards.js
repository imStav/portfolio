  ...
  state: () => ({
    cards: {
      pokedesk: {
        name: "Pokedesk",
        preview:
          "/assets/screenshots/pokedesk_dark_preview.png",
        description:
      ...
      rickandmorty: {
        ...
        preview:
          "/assets/screenshots/tracking-rickandmorty_preview.png",
        description:
      ...
      abstract: {
        name: "Abstract",
        preview:
          "/assets/screenshots/abstract_light_preview.png",
        description:
      ...
      dbz: {
        name: "DBZ JS",
        preview:
          "/assets/screenshots/dbz-js_preview.png",
        description:
      ...
      undefined: {
        ...
        preview:
          "/assets/screenshots/pop-undefined_preview.png",
        description:
